  ...
  return (
    <section id="contact" className="pt-10 pb-20 bg-slate-950/50">
      <div className="container mx-auto px-4 xl:px-24">
        <SectionHeading title="Get In Touch" subtitle="Let's work together" center={false} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_3fr] gap-12">
          ...
          >
            ...
            <div className="space-y-4">
              <a 
                href={`mailto:${portfolioData.social.find(s => s.platform === 'Email')?.url.replace('mailto:', '')}`}
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium">{portfolioData.social.find(s => s.platform === 'Email')?.url.replace('mailto:', '')}</p>
                </div>
              </a>
